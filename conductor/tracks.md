...
- [~] **Track: FX Snapshot + Multi-Currency — live FX via open.er-api.com, Postgres-cached rates (lazy 24h TTL), per-invoice snapshot frozen at send, manual override fallback, home-currency equivalents on invoice list/detail** *Link: [tracks/fx_multi_currency_20260908/index.md](./tracks/fx_multi_currency_20260908/index.md)*
